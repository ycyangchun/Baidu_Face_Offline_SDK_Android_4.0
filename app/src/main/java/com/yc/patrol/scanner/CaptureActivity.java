...
import com.yc.patrol.scanner.decode.CaptureActivityHandler;
import com.yc.patrol.scanner.view.ViewfinderBase;
import com.yc.patrol.scanner.view.ViewfinderView;
...
//                    .show();
        ...
        data.putExtra("scan", ResultParser.parseResult(rawResult).toString());
