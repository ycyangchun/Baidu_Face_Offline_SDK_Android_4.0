...
function BDFaceCopyProducts()
{
    ...
    facelibrarysopath=$workpath"/facelibrary/build/intermediates/jniLibs/release/*"
    # facelibraryjarspath=$workpath"/facelibrary/build/intermediates/jniLibs/release/libs/*"
    facelibraryclassspath=$workpath"/facelibrary/build/intermediates/packaged-classes/release/classes.jar"

    ls $workpath"/facelibrary/build/intermediates/jniLibs/release/armeabi-v7a/"
